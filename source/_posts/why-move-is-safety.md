...
![](./why-move-is-safety/MengXu-Move-Prover-09.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-18.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-22.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-27.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-34.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-37.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-39.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-40.jpg)
...
![img](./why-move-is-safety/v2-a1caf50d0c9d65be880b7995aa28adc4_1440w.webp)
...
![](./why-move-is-safety/MengXu-Move-Prover-44.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-46.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-49.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-50.jpg)

有了上图的规范代码后，你根本就不去关心它函数到底怎么实现，然后就可以去真正去写金融的实现，比如说你有一个取钱的函数，如下图的实现。

![](./why-move-is-safety/MengXu-Move-Prover-51.jpg)
...
![](./why-move-is-safety/MengXu-Move-Prover-07.jpg)
